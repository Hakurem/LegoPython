...
from HovedFiler.Main import Configs, data, init, addMeasurements, MathCalculations, setMotorPower, stopMotors
from moduler.funksjoner import RetreiveInputs, writeToFile, packLiveData, setPorts, CustomStopError, WriteAllToFile
try:
