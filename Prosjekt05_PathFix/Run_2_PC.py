...
# Making sure the project folder is in the temporary path
project_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.append(project_dir)
#________________________________________________________

# Adding explicit imports
from moduler.plotClass import PlotObject
from moduler.funksjoner import BunchPython, writeToFile, unpackMeasurement, parseMeasurements
from HovedFiler.Main import Configs, data, MathCalculations, lagPlot
...
def offline():
    try:
        ...
        # fr: file read
        # fw: file write
        file_read_path = os.path.join(project_dir, r'Data', Configs.filename)
        file_write_path = os.path.join(project_dir, r'Data', Configs.filenameOffline)
...
def sendInputs(connection):
    from moduler.JoystickPyglet import main
    main(connection)
    #from moduler.JoystickPygame import main
    #main(connection)
